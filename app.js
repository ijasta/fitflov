...
const TYPE_ICONS = {
  /* ── Cardio ── */
  'Running':          '<i class="ph ph-person-simple-run"></i>',
  'Cycling':          '<i class="ph ph-bicycle"></i>',
  'Swimming':         '<i class="ph ph-waves"></i>',
  'Jump Rope':        '<i class="ph ph-activity"></i>',
  'Treadmill':        '<i class="ph ph-person-simple-run"></i>',
  'Elliptical':       '<i class="ph ph-arrows-clockwise"></i>',
  'Rowing':           '<i class="ph ph-activity"></i>',
  'Stair Climbing':   '<i class="ph ph-steps"></i>',
  /* ── Gym / Strength ── */
  'Weight Training':  '<i class="ph ph-barbell"></i>',
  'Chest Press':      '<i class="ph ph-barbell"></i>',
  'Deadlift':         '<i class="ph ph-barbell"></i>',
  'Squats':           '<i class="ph ph-barbell"></i>',
  'Pull-Ups':         '<i class="ph ph-barbell"></i>',
  'Push-Ups':         '<i class="ph ph-barbell"></i>',
  'Shoulder Press':   '<i class="ph ph-barbell"></i>',
  'Bicep Curls':      '<i class="ph ph-barbell"></i>',
  'Leg Press':        '<i class="ph ph-barbell"></i>',
  'Cable Machine':    '<i class="ph ph-nut"></i>',
  'Dumbbell Workout': '<i class="ph ph-barbell"></i>',
  'Barbell Workout':  '<i class="ph ph-barbell"></i>',
  /* ── Classes & Flexibility ── */
  'HIIT':             '<i class="ph ph-lightning"></i>',
  'CrossFit':         '<i class="ph ph-lightning"></i>',
  'Circuit Training': '<i class="ph ph-arrows-clockwise"></i>',
  'Yoga':             '<i class="ph ph-heart"></i>',
  'Pilates':          '<i class="ph ph-heart"></i>',
  'Stretching':       '<i class="ph ph-activity"></i>',
  'Zumba':            '<i class="ph ph-music-notes"></i>',
  'Aerobics':         '<i class="ph ph-music-notes"></i>',
  /* ── Sports ── */
  'Basketball':       '<i class="ph ph-basketball"></i>',
  'Football':         '<i class="ph ph-soccer-ball"></i>',
  'Cricket':          '<i class="ph ph-baseball"></i>',
  'Badminton':        '<i class="ph ph-tennis-ball"></i>',
  'Tennis':           '<i class="ph ph-tennis-ball"></i>',
  'Table Tennis':     '<i class="ph ph-tennis-ball"></i>',
  'Volleyball':       '<i class="ph ph-volleyball"></i>',
  'Swimming Laps':    '<i class="ph ph-waves"></i>',
  /* ── Combat ── */
  'Boxing':           '<i class="ph ph-hand-fist"></i>',
  'Kickboxing':       '<i class="ph ph-hand-fist"></i>',
  'Martial Arts':     '<i class="ph ph-hand-fist"></i>',
  'Wrestling':        '<i class="ph ph-users"></i>',
  /* ── Other ── */
  'Rock Climbing':    '<i class="ph ph-mountains"></i>',
  'Cycling (Outdoor)':'<i class="ph ph-bicycle"></i>',
  'Walking':          '<i class="ph ph-person-simple-walk"></i>',
  'Dance':            '<i class="ph ph-music-notes"></i>',
  'Custom':           '<i class="ph ph-star"></i>'
};

const TYPE_COLORS = {
  /* Cardio — emerald */
  'Running':          ['#ECFDF5','#059669'],
  'Cycling':          ['#ECFDF5','#059669'],
  'Swimming':         ['#EFF6FF','#3B82F6'],
  'Jump Rope':        ['#ECFDF5','#059669'],
  'Treadmill':        ['#ECFDF5','#059669'],
  'Elliptical':       ['#ECFDF5','#059669'],
  'Rowing':           ['#EFF6FF','#3B82F6'],
  'Stair Climbing':   ['#ECFDF5','#059669'],
  /* Gym — teal */
  'Weight Training':  ['#F0FDFA','#0D9488'],
  'Chest Press':      ['#F0FDFA','#0D9488'],
  'Deadlift':         ['#F0FDFA','#0D9488'],
  'Squats':           ['#F0FDFA','#0D9488'],
  'Pull-Ups':         ['#F0FDFA','#0D9488'],
  'Push-Ups':         ['#F0FDFA','#0D9488'],
  'Shoulder Press':   ['#F0FDFA','#0D9488'],
  'Bicep Curls':      ['#F0FDFA','#0D9488'],
  'Leg Press':        ['#F0FDFA','#0D9488'],
  'Cable Machine':    ['#F0FDFA','#0D9488'],
  'Dumbbell Workout': ['#F0FDFA','#0D9488'],
  'Barbell Workout':  ['#F0FDFA','#0D9488'],
  /* HIIT / Classes — coral/red */
  'HIIT':             ['#FEF2F2','#EF4444'],
  'CrossFit':         ['#FEF2F2','#EF4444'],
  'Circuit Training': ['#FEF2F2','#EF4444'],
  'Zumba':            ['#FEF2F2','#EF4444'],
  'Aerobics':         ['#FEF2F2','#EF4444'],
  /* Flexibility — purple */
  'Yoga':             ['#F5F3FF','#8B5CF6'],
  'Pilates':          ['#F5F3FF','#8B5CF6'],
  'Stretching':       ['#F5F3FF','#8B5CF6'],
  /* Sports — amber */
  'Basketball':       ['#FFFBEB','#D97706'],
  'Football':         ['#FFFBEB','#D97706'],
  'Cricket':          ['#FFFBEB','#D97706'],
  'Badminton':        ['#FFFBEB','#D97706'],
  'Tennis':           ['#FFFBEB','#D97706'],
  'Table Tennis':     ['#FFFBEB','#D97706'],
  'Volleyball':       ['#FFFBEB','#D97706'],
  'Swimming Laps':    ['#EFF6FF','#3B82F6'],
  /* Combat — coral */
  'Boxing':           ['#FEF2F2','#EF4444'],
  'Kickboxing':       ['#FEF2F2','#EF4444'],
  'Martial Arts':     ['#FEF2F2','#EF4444'],
  'Wrestling':        ['#FEF2F2','#EF4444'],
  /* Other */
  'Rock Climbing':    ['#F0FDFA','#0D9488'],
  'Cycling (Outdoor)':['#ECFDF5','#059669'],
  'Walking':          ['#ECFDF5','#059669'],
  'Dance':            ['#F5F3FF','#8B5CF6'],
  'Custom':           ['#F1F5F9','#475569']
};

const CAT_ICONS = {'Endurance':'<i class="ph ph-person-simple-run"></i>','Strength':'<i class="ph ph-barbell"></i>','Weight Loss':'<i class="ph ph-scales"></i>','Flexibility':'<i class="ph ph-heart"></i>','Consistency':'<i class="ph ph-calendar"></i>','Distance':'<i class="ph ph-map-pin"></i>'};
const CAT_BG    = {'Endurance':'#ECFDF5','Strength':'#F0FDFA','Weight Loss':'#FFFBEB','Flexibility':'#F5F3FF','Consistency':'#FFFBEB','Distance':'#EFF6FF'};
...
const DB = {
  ...
  signup: async (firstName, lastName, email, password, age, goal) => {
    ...
    const { error: pErr } = await _sb.from('profiles').upsert({ id: data.user.id, first_name: firstName, last_name: lastName, age: age||null, fitness_goal: goal });
    if (pErr) console.warn("Profile insert deferred:", pErr.message);
    return data;
  },
  ...
  /* Split Program */
  loadSplit: async (uid) => {
    const { data, error } = await _sb.from('split_data').select('*').eq('user_id', uid).single();
    if (error && error.code !== 'PGRST116') throw new Error(error.message);
    return data || null;
  },
  saveSplit: async (uid, splitJson, activeDay, cycleStart) => {
    const { error } = await _sb.from('split_data').upsert({ user_id: uid, split_json: splitJson, active_day: activeDay, cycle_start: cycleStart }, { onConflict: 'user_id' });
    if (error) throw new Error(error.message);
  },
  ...
  getGlobalStats: async () => {
    const [uRes, wRes] = await Promise.all([
      ...
      _sb.from('workouts').select('*', { count: 'exact', head: true })
    ]);
    return { users: uRes.count || 0, workouts: wRes.count || 0 };
  }
};
...
let _authErrTimeouts = {};
function showAuthErr(id, msg) {
  const el = document.getElementById(id);
  el.textContent = msg; el.classList.add('show');
  if (_authErrTimeouts[id]) clearTimeout(_authErrTimeouts[id]);
  _authErrTimeouts[id] = setTimeout(() => el.classList.remove('show'), 6000);
}
...
async function doSignup() {
  ...
  try {
    const data = await DB.signup(first, last, email, pass, age, goal);
    if (!data.session) {
      toast('Registration successful! Please check your email to confirm.', '✉️');
      ...
      switchAuthTab('login');
      showAuthErr('loginErr', 'Please check your email and confirm your account before logging in.');
    } else {
...
async function doLogin() {
  ...
  try {
    ...
    if (e.message.includes('Invalid login credentials')) {
      showAuthErr('loginErr', 'Email not found or incorrect password.');
    } else {
      showAuthErr('loginErr', e.message);
    }
  }
...
async function loadApp(user) {
  ...
  try {
    const [profile, workouts, planned, goals, splitRow] = await Promise.all([
      DB.getProfile(user.id), DB.loadWorkouts(user.id),
      DB.loadPlanned(user.id), DB.loadGoals(user.id), DB.loadSplit(user.id)
    ]);
    ...
    allPlanned  = planned;
    allGoals    = goals;
    _cachedSplitRow = splitRow;

    // Check Admin status
    const isAdmin = user.email === 'ijasta3@gmail.com' || user.user_metadata?.is_admin === true;
  ...
  ['logTypePicker','planTypePicker'].forEach(pickerId => {
    ...
    let html = `<div style="margin-bottom:8px;">
      <input type="text" placeholder="🔍 Search workout type…"
        ...
        style="width:100%;padding:9px 13px;border:1.5px solid var(--border2);border-radius:11px;font-size:13px;font-family:var(--font-body);background:var(--bg);color:var(--text);outline:none;margin-bottom:10px;"
      />
    </div>
...
function renderStats() {
  ...
  const cards = [
    { lbl:'Workouts', val: ww.length,                              note:'this week',     delta:'↑ on track',    col:'#059669', bg:'#ECFDF5', ico:'💪', bar:'#10B981' },
    { lbl:'Calories', val: ww.reduce((a,w)=>a+getKcal(w),0).toLocaleString(), note:'kcal this week', delta:'↑ great effort', col:'#0D9488', bg:'#F0FDFA', ico:'🔥', bar:'#0D9488' },
    { lbl:'Minutes',  val: ww.reduce((a,w)=>a+getDur(w),0),        note:'min this week',  delta:'↑ improving',   col:'#D97706', bg:'#FFFBEB', ico:'⏱', bar:'#D97706' },
    { lbl:'Streak',   val: calcStreak(),                            note:'days in a row',  delta:'keep going!',   col:'#8B5CF6', bg:'#F5F3FF', ico:'⚡', bar:'#8B5CF6' }
  ];
...
function renderWeekChart() {
  ...
  document.getElementById('weekChart').innerHTML = labels.map((d, i) => {
    ...
    const col     = isToday ? '#059669' : data[i] > 0 ? '#10B981' : '#E2E8F0';
    const outline = isToday ? 'outline:2px solid #059669;outline-offset:2px;' : '';
...
function renderDashGoals() {
  const colors = ['#10B981','#0D9488','#D97706','#8B5CF6'];
...
/* ============================================================
   LOG WORKOUT — Auto Calorie Estimation
   ============================================================ */
const CALORIE_RATES = {
  'Running':        { Easy:8, Moderate:11, Hard:14, Maximum:17 },
  'Cycling':        { Easy:6, Moderate:9,  Hard:12, Maximum:15 },
  'Swimming':       { Easy:7, Moderate:10, Hard:13, Maximum:16 },
  'Jump Rope':      { Easy:9, Moderate:12, Hard:15, Maximum:18 },
  'Treadmill':      { Easy:7, Moderate:10, Hard:13, Maximum:16 },
  'Elliptical':     { Easy:6, Moderate:8,  Hard:11, Maximum:14 },
  'Rowing':         { Easy:6, Moderate:9,  Hard:12, Maximum:15 },
  'Stair Climbing': { Easy:7, Moderate:10, Hard:13, Maximum:16 },
  'Weight Training': { Easy:4, Moderate:6, Hard:8,  Maximum:10 },
  'Chest Press':    { Easy:4, Moderate:6,  Hard:8,  Maximum:10 },
  'Deadlift':       { Easy:5, Moderate:7,  Hard:9,  Maximum:11 },
  'Squats':         { Easy:5, Moderate:7,  Hard:9,  Maximum:11 },
  'Pull-Ups':       { Easy:5, Moderate:7,  Hard:9,  Maximum:11 },
  'Push-Ups':       { Easy:5, Moderate:7,  Hard:9,  Maximum:11 },
  'Shoulder Press': { Easy:4, Moderate:6,  Hard:8,  Maximum:10 },
  'Bicep Curls':    { Easy:3, Moderate:5,  Hard:7,  Maximum:9 },
  'Leg Press':      { Easy:5, Moderate:7,  Hard:9,  Maximum:11 },
  'HIIT':           { Easy:8, Moderate:12, Hard:15, Maximum:18 },
  'CrossFit':       { Easy:8, Moderate:12, Hard:15, Maximum:18 },
  'Circuit Training': { Easy:7, Moderate:10, Hard:13, Maximum:16 },
  'Yoga':           { Easy:3, Moderate:4,  Hard:5,  Maximum:6 },
  'Pilates':        { Easy:3, Moderate:5,  Hard:6,  Maximum:8 },
  'Stretching':     { Easy:2, Moderate:3,  Hard:4,  Maximum:5 },
  'Zumba':          { Easy:6, Moderate:9,  Hard:11, Maximum:14 },
  'Aerobics':       { Easy:6, Moderate:8,  Hard:11, Maximum:13 },
  'Basketball':     { Easy:6, Moderate:9,  Hard:12, Maximum:14 },
  'Football':       { Easy:6, Moderate:9,  Hard:12, Maximum:14 },
  'Cricket':        { Easy:4, Moderate:6,  Hard:8,  Maximum:10 },
  'Badminton':      { Easy:5, Moderate:7,  Hard:10, Maximum:13 },
  'Tennis':         { Easy:6, Moderate:8,  Hard:11, Maximum:14 },
  'Boxing':         { Easy:8, Moderate:11, Hard:14, Maximum:17 },
  'Kickboxing':     { Easy:8, Moderate:11, Hard:14, Maximum:17 },
  'Martial Arts':   { Easy:7, Moderate:10, Hard:13, Maximum:16 },
  'Walking':        { Easy:3, Moderate:5,  Hard:6,  Maximum:8 },
  'Rock Climbing':  { Easy:7, Moderate:10, Hard:13, Maximum:16 },
  'Dance':          { Easy:5, Moderate:7,  Hard:10, Maximum:12 },
  '_default':       { Easy:5, Moderate:7,  Hard:9,  Maximum:11 }
};

function estimateCalories() {
  const dur = parseInt(document.getElementById('wDur').value) || 0;
  const intensity = document.getElementById('wIntensity').value;
  const rates = CALORIE_RATES[logSelType] || CALORIE_RATES['_default'];
  const rate = rates[intensity] || rates['Moderate'];
  const hint = document.getElementById('calEstHint');
  if (dur > 0) {
    const est = Math.round(dur * rate);
    document.getElementById('wCals').value = est;
    if (hint) hint.textContent = `≈ ${rate} kcal/min × ${dur} min = ${est} kcal (auto-estimated)`;
  } else {
    if (hint) hint.textContent = 'Enter duration to auto-estimate calories';
  }
}
...
async function saveWorkout() {
  ...
  if (!duration) return toast('Please enter duration', '⚠');
  try {
...
function renderHistory(data) {
  ...
  body.innerHTML = data.map(w => {
    const [bg, fg] = TYPE_COLORS[w.type] || ['#F1F5F9','#475569'];
    return `<tr>
      <td style="color:#94A3B8;white-space:nowrap">${fmtDate(w.date)}</td>
      <td><strong>${w.name}</strong></td>
      <td><span class="badge" style="background:${bg};color:${fg}">${w.type}</span></td>
      <td>${getDur(w)} min</td>
      <td style="font-weight:600;color:#EF4444">${getKcal(w)} kcal</td>
      <td>${getDist(w) > 0 ? getDist(w) + ' km' : '—'}</td>
      <td style="color:#94A3B8">${w.intensity||'—'}</td>
      <td style="color:#94A3B8;font-size:12px;max-width:140px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap">${w.notes||'—'}</td>
...
function renderGoals() {
  const colors = ['#10B981','#0D9488','#D97706','#8B5CF6','#3B82F6','#EF4444'];
...
function renderRings() {
  ...
  const rings = [
    { name:'Weekly Sessions', val: ww.length,                          tgt:6,    unit:'/ 6 sessions', col:'#059669', bg:'#ECFDF5' },
    { name:'Calories Burned',  val: ww.reduce((a,w)=>a+getKcal(w),0), tgt:3200, unit:'kcal',          col:'#0D9488', bg:'#F0FDFA' },
    { name:'Recent Distance',  val: dist.toFixed(1),                   tgt:40,   unit:'km',            col:'#D97706', bg:'#FFFBEB' }
  ];
...
function renderMonthChart() {
  ...
  document.getElementById('monthChart').innerHTML = months.map((m, i) => {
    ...
    return `<div class="bar-col"><div class="bar-val">${data[i]||''}</div><div class="bar-fill" style="height:${h}px;background:${isLast?'#059669':'#10B981'};opacity:${isLast?1:0.6}"></div><div class="bar-day" style="color:${isLast?'#059669':'#94A3B8'};font-weight:${isLast?600:400}">${m.lbl}</div></div>`;
  }).join('');
}
...
function renderTypeBreak() {
  ...
  document.getElementById('typeBreak').innerHTML = sorted.length
    ? sorted.map(([type, count]) => {
        const [, fg] = TYPE_COLORS[type] || ['#F1F5F9','#475569'];
        const pct    = Math.round((count / total) * 100);
        return `<div style="margin-bottom:10px;"><div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:5px;"><span style="font-size:13px;font-weight:500">${TYPE_ICONS[type]||'🏃'} ${type}</span><span style="font-size:12px;color:#94A3B8">${count} sessions · ${pct}%</span></div><div class="prog-track"><div class="prog-bar" style="width:${pct}%;background:${fg}"></div></div></div>`;
      }).join('')
    : '<div style="text-align:center;padding:20px;color:#94A3B8">No workouts yet</div>';
}
...
function calcBMI() {
  ...
  const [cat, col] = bmi < 18.5 ? ['Underweight','#3B82F6'] : bmi < 25 ? ['Normal weight','#059669'] : bmi < 30 ? ['Overweight','#D97706'] : ['Obese','#EF4444'];
...
function renderProfile() {
  ...
  document.getElementById('acctStats').innerHTML = [
    { lbl:'Member Since',     val: fmtDate(currentUser.joined),                                         col:'#94A3B8' },
    { lbl:'Total Workouts',   val: allWorkouts.length,                                                   col:'#059669' },
    { lbl:'Total Calories',   val: allWorkouts.reduce((a,w)=>a+getKcal(w),0).toLocaleString()+' kcal',  col:'#EF4444' },
    { lbl:'Goals Set',        val: allGoals.length,                                                      col:'#8B5CF6' },
    { lbl:'Planned Workouts', val: allPlanned.length,                                                    col:'#0D9488' }
...
/* ── SPLIT STORAGE (Supabase — split_data table) ── */
let _splitCycleStart = null;
let _saveSplitTimer  = null;

function loadSplitData() {
  const row = _cachedSplitRow;
  if (row && row.split_json) {
    splitData = typeof row.split_json === 'string' ? JSON.parse(row.split_json) : row.split_json;
    activeSplitDay   = row.active_day   || getCurrentCycleDay();
    _splitCycleStart = row.cycle_start  || new Date().toISOString().split('T')[0];
  } else {
    ...
    _splitCycleStart = new Date().toISOString().split('T')[0];
    saveSplitData();
  }
}
...
function saveSplitData() {
  if (!currentUser) return;
  if (_cachedSplitRow) {
    _cachedSplitRow.split_json  = splitData;
    _cachedSplitRow.active_day  = activeSplitDay;
    _cachedSplitRow.cycle_start = _splitCycleStart;
  } else {
    _cachedSplitRow = { split_json: splitData, active_day: activeSplitDay, cycle_start: _splitCycleStart };
  }
  clearTimeout(_saveSplitTimer);
  _saveSplitTimer = setTimeout(async () => {
    try { await DB.saveSplit(currentUser.id, splitData, activeSplitDay, _splitCycleStart); }
    catch (e) { console.error('Split save error:', e.message); }
  }, 1500);
}

function saveActiveSplitDay() {
  if (_cachedSplitRow) _cachedSplitRow.active_day = activeSplitDay;
  saveSplitData();
}

/* Calculate which day in the 4-day cycle today is, based on the app start date */
function getCurrentCycleDay() {
  if (!_splitCycleStart) _splitCycleStart = new Date().toISOString().split('T')[0];
  const diff = Math.floor((new Date() - new Date(_splitCycleStart + 'T00:00:00')) / 86400000);
  return (diff % 4) + 1;
}
...
function resetSplitDay() {
  _splitCycleStart = new Date().toISOString().split('T')[0];
  activeSplitDay = 1;
  /* Reset all exercises across ALL days */
  splitData.forEach(d => {
  ...
  saveSplitData();
  renderSplitPage();
  renderTodaySplitDash();
  renderStats();
  toast('All days reset to Day 1 ↺', '🔀');
}
      ...
      <div class="today-split-banner">
        ...
        <div class="tsb-right">
          ...
          <div style="text-align:right;">
            <div style="font-size:12px;color:var(--text3);">${doneEx === totalEx && totalEx > 0 ? '🎉 Complete!' : 'exercises done'}</div>
...
function updateSetLog(exId, setIdx, field, value) {
  ...
  renderSplitPage();
  renderTodaySplitDash();   /* keep homepage Today's Plan in sync */
}
...
function toggleExDone(exId) {
  ...
  /* Auto-log workout if ALL exercises in this day are now done */
  const allDone = dayObj.exercises.length > 0 && dayObj.exercises.every(e => e.done);
  if (allDone) autoLogSplitWorkout(dayObj);
}
...
function markDaySplitDone() {
  ...
  renderTodaySplitDash();
  renderStats();
  autoLogSplitWorkout(dayObj);
  toast(`Day ${activeSplitDay} complete! 🎉`, '🏆');
}

/* Auto-log a workout entry when a split day is fully completed.
   Skips if a split workout for this day was already logged today. */
async function autoLogSplitWorkout(dayObj) {
  if (!currentUser || !dayObj) return;
  const todayISO = new Date().toISOString().split('T')[0];
  const splitName = `Day ${dayObj.day}: ${dayObj.name}`;
  /* Avoid duplicate: if a split workout for this day was already logged today, skip */
  const alreadyLogged = allWorkouts.some(w => w.date === todayISO && w.name === splitName);
  if (alreadyLogged) return;

  /* Estimate calories: ~6 kcal per set; duration: ~3 min per set */
  const totalSets = dayObj.exercises.reduce((a, ex) => a + (ex.sets || 3), 0);
  const estCals   = totalSets * 6;
  const estMins   = Math.round(totalSets * 3);

  try {
    const saved = await DB.addWorkout({
      ...
      distance:  0,
      intensity: 'Moderate',
      notes:     `Split workout — Day ${dayObj.day} — ${dayObj.exercises.length} exercises, ${totalSets} sets`
    });
    allWorkouts.unshift(saved);
    allWorkouts.sort((a, b) => new Date(b.date || 0) - new Date(a.date || 0));
    renderStats();
    renderWeekChart();
    renderRecentWo();
    toast(`Workout logged! ${estMins}min · ${estCals}kcal 📊`, '📊');
  } catch (e) {
    console.error('Auto-log error:', e.message);
    toast('Could not auto-log workout: ' + e.message, '❌');
  }
}

async function resetDaySplit() {
  const dayObj = splitData.find(d => d.day === activeSplitDay);
  if (!dayObj) return;
  dayObj.exercises.forEach(ex => {
    ex.done = false;
  ...
  /* Remove from history if it was auto-logged today */
  if (currentUser) {
    const todayISO = new Date().toISOString().split('T')[0];
    const splitName = `Day ${dayObj.day}: ${dayObj.name}`;
    const loggedIdx = allWorkouts.findIndex(w => w.date === todayISO && w.name === splitName);
    if (loggedIdx !== -1) {
      const wId = allWorkouts[loggedIdx].id;
      allWorkouts.splice(loggedIdx, 1);
      renderStats();
      if (typeof renderWeekChart === 'function') renderWeekChart();
      renderRecentWo();
      if (typeof filterHist === 'function') filterHist();
      try {
        await DB.deleteWorkout(wId);
      } catch(e) {
        console.error('Failed to delete auto-logged workout:', e);
      }
    }
  }

  toast('Day ' + activeSplitDay + ' reset ↺', '↺');
}
...
function renderTodaySplitDash() {
  loadSplitData();   /* always reload from localStorage so done flags are fresh */
  const todayCycle = getCurrentCycleDay();
  ...
  el.innerHTML = `
    <div style="display:flex;align-items:center;justify-content:space-between;padding:10px 14px;background:var(--surface2);border-radius:12px;margin-bottom:10px;">
      <div>
        <div style="font-size:12px;font-weight:500;color:var(--text);">Day ${dayObj.day} · ${dayObj.name}</div>
        <div style="font-size:11px;color:var(--text);opacity:.7;">${done}/${total} exercises done</div>
      </div>
    ...
    <div class="wo-list">${dayObj.exercises.slice(0,4).map((ex, i) => `
      <div class="wo-item" style="${ex.done?'opacity:.5':''}">
        <div class="ex-order" style="background:var(--surface2);color:var(--accent);width:34px;height:34px;font-size:12px;flex-shrink:0;">${i+1}</div>
        <div class="wo-info">
        ...
        <span style="font-size:11px;padding:3px 9px;border-radius:7px;background:${ex.done?'var(--teal-light)':'var(--surface2)'};color:${ex.done?'var(--teal)':'var(--text3)'};">${ex.done?'Done':'Todo'}</span>
      </div>`).join('')}
...
function goTo(page, btn) {
  ...
  const renders = {
    ...
    log:       () => { buildTypePickers(); const todayISO = new Date().toISOString().split('T')[0]; document.getElementById('wDate').value = todayISO; },
...
window.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    ...
    const eW = document.getElementById('statWorkouts');
    if (eU) eU.textContent = stats.users;
    if (eW) eW.textContent = stats.workouts;
